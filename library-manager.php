...
require_once LM_PLUGIN_DIR . 'includes/class-library-deactivator.php';
...
require_once LM_PLUGIN_DIR . 'includes/helpers.php';

// Activation/Deactivation Hooks
register_activation_hook( __FILE__, [ 'Library_Activator', 'activate' ] );
register_deactivation_hook( __FILE__, [ 'Library_Deactivator', 'deactivate' ] );
